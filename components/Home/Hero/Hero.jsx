  ...
  return (
    <div className="flex flex-col md:flex-row justify-center mt-12">
      <div className=" w-full md:w-1/2 flex flex-col items-center md:items-start mb-6 md:mb-0">
        <h1 className="text-white text-4xl md:text-5xl lg:text-6xl lg:leading-[78px] font-bold tracking-wider">
          Sugar cane <br />
          juice <span className="text-[#55236d]">Vendor</span>
        </h1>
        <p className="mt-6 text-sm md:text-base text-white leading-7 font-medium pb-12 block text-center md:text-start">
