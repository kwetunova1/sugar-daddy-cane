...
export default function Hero() {
  return (
    <div className="flex justify-center mt-12">
      <div className="w-1/2">
        <h1 className="text-white text-6xl leading-[78px] font-bold">
          Sugar cane <br />
          juice <span className="text-[#55236d]">Vendor</span>
        </h1>
        <p className="text-base text-white leading-7 font-medium pb-12 block">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita quae
          laudantium, sequi ullam facere numquam quibusdam dolores rem aut nemo!
        </p>
